...
class Krotov_optimizer_Fredkin_Shorten():
    def __init__(self,N_Iteration=100,N_T=104):
        self.dirpath = os.path.dirname(__file__)
        self.datapath = self.dirpath + os.sep + "data_Fredkin_" + str(N_T) + "_short.pickle"
